...
class MessageDescriptorMap extends Map {
}
 ...
 */
class ProtoCollection$1 {
    constructor(fileDescriptorSet, modules) {
        this.fileDescriptorSet = fileDescriptorSet;
        this.messages = new MessageMap();
        this.messageDescriptors = new MessageDescriptorMap();
    ...
    mapMessages(set, mods) {
        for (const fileDescriptor of set.getFileList()) {
            ...
            for (const messageType of fileDescriptor.getMessageTypeList()) {
                const fullName = fileDescriptor.getPackage() + '.' + messageType.getName();
...
import * as proto_0 from './pigweed/pw_rpc/echo_pb';
import * as proto_1 from './pigweed/pw_protobuf/pw_protobuf_protos/status_pb';
import * as proto_2 from './pigweed/pw_protobuf/pw_protobuf_protos/common_pb';
import * as proto_3 from './pigweed/pw_tokenizer/options_pb';
import * as proto_4 from './pigweed/pw_rpc/internal/packet_pb';
import * as proto_5 from './app/proto/demo_pb';
const MODULE_MAP = new ModuleMap([
['pigweed/pw_rpc/echo.proto', proto_0],
['pigweed/pw_protobuf/pw_protobuf_protos/status.proto', proto_1],
['pigweed/pw_protobuf/pw_protobuf_protos/common.proto', proto_2],
['pigweed/pw_tokenizer/options.proto', proto_3],
['pigweed/pw_rpc/internal/packet.proto', proto_4],
['app/proto/demo.proto', proto_5],
]);
const DESCRIPTOR_BASE64_BINARY = '';
/**
 * A wrapper class of protocol buffer modules to provide convenience methods.
 */
class ProtoCollection extends ProtoCollection$1 {
    constructor() {
